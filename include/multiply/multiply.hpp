...
void std_transform_multiply(int n, double const* a, double const* b,
                                      double* c);
...
void cuda_host_multiply(int n, double const* a, double const* b, double* c) {
  cuda_host_multiply_impl(threads_per_block, n, a, b, c);
}
