...
struct single_threaded_multiply {
  void operator()(std::size_t n, double const* a, double const* b, double* c);
};

struct std_transform_multiply {
  void operator()(std::size_t n, double const* a, double const* b, double* c);
};
struct par_std_transform_multiply {
  void operator()(std::size_t n, double const* a, double const* b, double* c);
};
...
void cuda_device_multiply_impl(std::size_t threads_per_block, std::size_t n,
                               ...
                               double* dev_c);
template <std::size_t threads_per_block>
struct cuda_device_multiply {
  void operator()(std::size_t n, double const* dev_a, double const* dev_b,
                  double* dev_c) {
